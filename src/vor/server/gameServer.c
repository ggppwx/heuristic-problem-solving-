 ...
 * ===  FUNCTION  ======================================================================
 *         Name:  drawLines
 *  Description:  Draws the lines based on the position of the stones. Also paint the
 *                interior of the polygons
 * =====================================================================================
 */
void drawLines (  ) {
    /* TODO: Draw the lines and paint the polygons and shit */
}		
/* -----  end of function drawLines  ----- */
...
void openPort ( int portno, int *sockfd, int *newsockfd ) {
     ...
     *newsockfd = accept(*sockfd, 
     ...
     setsockopt( *newsockfd, SOL_SOCKET, SO_RCVBUF, &n, sizeof(n));
     setsockopt( *newsockfd, SOL_SOCKET, SO_SNDBUF, &n, sizeof(n));
 ...
 * ===  FUNCTION  ======================================================================
 *         Name:  updateGeometry
 *  Description:  Updates the lines based on the stones on the board. Also compute the
 *                score for each player. This function doesn't draw anything, just
 *                internally compute the geometry so that drawLines() will actually draw it.
 * =====================================================================================
 */
void updateGeometry (  ) {
    /* TODO: Implement this shit! */
}		
/* -----  end of function updateGeometry  ----- */
...
void parseMessage ( char buffer[1024] ) {
    ...
    /* Update the geometry and compute scores */
